...
[![CI status](https://github.com/weserv/images/workflows/CI/badge.svg?branch=4.x)](https://github.com/weserv/images/actions)

Source code of wsrv.nl (formerly images.weserv.nl), to be used on your own server(s). weserv/images leverages
powerful libraries like [lua-vips](https://github.com/libvips/lua-vips) (for image handling and manipulation),
[lua-resty-http](https://github.com/ledgetech/lua-resty-http) (for sending HTTP requests)
and [OpenResty](https://github.com/openresty/) (used as web server and HTTP cache).
